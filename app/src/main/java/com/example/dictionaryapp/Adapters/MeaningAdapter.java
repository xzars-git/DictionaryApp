...
public class MeaningAdapter extends RecyclerView.Adapter<MeaningsViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MeaningsViewHolder holder, int position) {
        holder.textView_partsOfSpeach.setText("Parts of Speech: "+meaningsList.get(position).getPartOfSpeech());
        ...
        DefinitionAdapter definitionAdapter = new DefinitionAdapter(context, meaningsList.get(holder.getAdapterPosition()).getDefinitions());
