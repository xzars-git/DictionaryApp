...
public class DefinitionAdapter extends RecyclerView.Adapter<DefinitionViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DefinitionViewHolder holder, int position) {
        holder.textView_definition.setText("Definition: "+definitionsList.get(holder.getAdapterPosition()).getDefinition());
        holder.textView_example.setText("Example: "+definitionsList.get(holder.getAdapterPosition()).getExample());
